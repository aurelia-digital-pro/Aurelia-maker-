...
class FactoryRunner:
    ...
    def run_episode_production(self, job: ProductionJob, script_path: Path, profile: str = "both") -> dict[str, Any]:
        ...
        final_validation["frame_content"] = inspect_final_video_visuals(final_outputs["final"])
        final_validation["passed"] = final_validation["passed"] and final_validation["frame_content"]["passed"]
